...
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.fir.autotvin_a.dat"
...
parameter LATENCY_ESTIMATION = 523;
...
begin
    ...
    initial begin : proc_gen_axis_internal_ready_a
        ...
        @ (posedge ready_initial);
        forever begin
            @ (ap_c_n_tvin_trans_num_a or a_transaction);
            if (ap_c_n_tvin_trans_num_a > a_transaction) begin
                a_ready_reg = 1;
            end else begin
                a_ready_reg = 0;
            end
