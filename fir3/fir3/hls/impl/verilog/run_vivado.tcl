...
dict set report_options funcmodules {fir_fir_Pipeline_1 fir_fir_Pipeline_sample_loop}
dict set report_options bindmodules {fir_flow_control_loop_pipe_sequential_init fir_control_s_axi fir_regslice_both}
